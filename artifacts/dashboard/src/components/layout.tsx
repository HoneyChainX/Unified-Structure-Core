...
import { Activity, LayoutDashboard, List, Bot, BarChart2, FlaskConical, Zap, Smartphone, Coins } from "lucide-react";
...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { href: "/symbol-stats", icon: Coins, label: "Symbols", active: location === "/symbol-stats" },
